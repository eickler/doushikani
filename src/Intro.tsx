import { Box, Button, Checkbox, FormControlLabel, MobileStepper, Typography } from "@material-ui/core";
...
const Intro = (props: Props) => {
  ...
  const steps = [
    ...
    <>
      ...
      <Button variant="contained" color="primary" onClick={() => props.onFinish(skip)}>Let's get started!</Button>
      <p><FormControlLabel
